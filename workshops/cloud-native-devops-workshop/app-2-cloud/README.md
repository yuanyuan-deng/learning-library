...
<span style="display:block;text-align:center" markdown="1"> ![](images/app2cloud.arhitecture.png) </span>
<div style="display:block;text-align:center"> ![](images/app2cloud.arhitecture.png) </div>
